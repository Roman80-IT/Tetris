...
Натискаємо на квадратик перед `lightgrey` (у VSC) і у вікні, яке з'явиться можемо змінити колір або просто встановити прозорість:
...
Ця частина тіні створює ефект тіні зліва у верхньому куті.<br>
...
Ця частина тіні створює ефект тіні справа в нижньому куті<br>
